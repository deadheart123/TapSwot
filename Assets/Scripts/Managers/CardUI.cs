...
public class CardUI : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        if (CardGameManager.instance.GetGameState() == GameStateEnum.ROUND_TWO || CardGameManager.instance.GetGameState() == GameStateEnum.ROUND_TWO_END || CardGameManager.instance.GetGameState() == GameStateEnum.ROUND_ONE ||
